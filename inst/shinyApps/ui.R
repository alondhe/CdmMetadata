...
ui <- dashboardPage(
  ...
  dashboardSidebar(width = "300px",
    ...
    conditionalPanel(condition = "input.tabs == 'entityActivity'",
                     ...
                     textInput(inputId = "entityIdentifier", label = "Entity Identifer", width = "250px"),
                     textInput(inputId = "activityConceptId", label = "Activity Concept Id", width = "250px", value = 0), 
                     # selectInput(inputId = "activityConceptClass", label = "Activity Concept Class", width = "250px",
                     #             choices = c("Data Quality",
                     #                         "Provenance",
                     #                         "ETL/Design")),
                     # selectInput(inputId = "activityConceptId2", label = "Activity", width = "250px", 
                     #             choices = c("Conformance" = 900000112,
                     #                         "Completeness" = 900000113,
                     #                         "Plausibility" = 900000114	,
                     #                         "Temporal Event" = 900000115,
                     #                         "Value" = 900000116)),
                     textInput(inputId = "activityTypeConceptId", label = "Activity Type Concept Id", width = "250px", value = 0),
                     textInput(inputId = "activityAsString", label = "Activity As String", width = "250px"),
                     dateRangeInput(inputId = "activityDates", label = "Activity Date Start and End", width = "250px"),
    ...
    conditionalPanel(condition = "input.tabs == 'annotation'",
                     textInput(inputId = "annotationConceptId", label = "Annotation Concept Id", width = "250px", value = 0),
                     textInput(inputId = "annotationTypeConceptId", label = "Annotation Type Concept Id", width = "250px", value = 0),
  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem("entityActivity",
              ...
              DT::dataTableOutput("dtEntityActivity"),
              ...
              fluidRow(
                column(3,
                       wellPanel(
                         numericInput(inputId = "valueOrdinalEA", value = 1, label = "Ordinal", width = "250px"),
                         textInput(inputId = "valueConceptIdEA", label = "Value Concept Id", width = "250px", value = 0),
                         textInput(inputId = "valueTypeConceptIdEA", label = "Value Type Concept Id", width = "250px", value = 0),
                         textInput(inputId = "valueAsStringEA", label = "Value As String", width = "250px"),
                         numericInput(inputId = "valueAsNumberEA", label = "Value As Number", value = 0, width = "250px"),
                         textInput(inputId = "operatorConceptIdEA", label = "Operator Concept Id", value = 0, width = "250px"), 
              ...
              tabItem("annotation", 
                       ...
                       fluidRow(
                         column(3,
                                wellPanel(
                                  numericInput(inputId = "valueOrdinalAnn", value = 1, label = "Ordinal", width = "250px"),
                                  textInput(inputId = "valueConceptIdAnn", label = "Value Concept Id", width = "250px", value = 0),
                                  textInput(inputId = "valueTypeConceptIdAnn", label = "Value Type Concept Id", width = "250px", value = 0),
                                  textInput(inputId = "valueAsStringAnn", label = "Value As String", width = "250px"),
                                  numericInput(inputId = "valueAsNumberAnn", label = "Value As Number", value = 0, width = "250px"),
                                  textInput(inputId = "operatorConceptIdAnn", label = "Operator Concept Id", width = "250px", value = 0), 
